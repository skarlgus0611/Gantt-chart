...
const APP_VERSION = "2026-09-21-n";
...
function buildCaptureChart() {
  ...
  /* 공용 .month-bands 스타일은 세로 창(뷰포트) 기준으로 top:0 인데,
     여기서는 그런 창이 없으니 헤더(52px) 아래부터 시작하도록
     직접 지정한다. 안 그러면 배경이 헤더 글자를 덮어 버린다. */
  bands.style.top = "52px";
